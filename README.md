...
├── README.md                                    # このファイル
├── docs/
│   ├── family-meeting-plan-v2.md                # 実装計画書（MVPスコープ）
│   ├── system-prompt-v1.md                      # Claudeに渡すシステムプロンプト本体
│   └── step1-instructions-for-claude-code.md    # Step1プロトタイプ実装指示書
├── prototype/
...
詳細は [`docs/step1-instructions-for-claude-code.md`](./docs/step1-instructions-for-claude-code.md) を参照。
...
- [実装計画書](./docs/family-meeting-plan-v2.md) - MVP全体のスコープ・仕様・計測設計
- [システムプロンプト](./docs/system-prompt-v1.md) - Claudeに渡すプロンプト本体と設計判断
- [Step1 実装指示書](./docs/step1-instructions-for-claude-code.md) - ローカル検証プロトタイプの実装手順
